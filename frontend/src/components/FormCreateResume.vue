<template>
    <form class="area-form" @submit.prevent>
        ...
        <h3>О себе: </h3>
        <textarea name="about_me" id="about_me" placeholder="Описание" v-model="about_me" rows="10"></textarea>
        
        <div class="area-button">
            <button class="button-style" @click="CreateResume">Создать</button>
        </div>
    </form>
